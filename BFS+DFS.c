...
void printTabelaDFS(int tabelaDFS[TAM][5], int tamanho, int i) {
    printf("\nEstado atual\n");
    printf("vert\t|dist\t|ant\t|visit\n");
    for (int linha = 0; linha < tamanho; linha++){
        //printf("Linha %d", linha);
        for (int coluna = 0; coluna < 5; coluna++){
            if (tabelaDFS[linha][coluna])
...
int main() {//                         A  B  C  D  E  F  G
    ...
    int tabelaBFS[TAM][4] = {{0, INT_MAX, -1, 0},
                             {1, INT_MAX, -1, 0},
                             {2, INT_MAX, -1, 0},
                             {3, INT_MAX, -1, 0},
                             {4, INT_MAX, -1, 0},
    ...
    // printTabelaDFS(tabelaDFS, TAM, 0);
    // printTabelaBFS(tabelaBFS, TAM, 0);
    return 0;
}